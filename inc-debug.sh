...
_var_replace_vars() {
    local vars
        ...
        case $1 in
            ...
            haproxy)
                vars="S_RSYSLOG_PORT _SOMAXCONN _HPX_PATH_SSL _HPX_LCRYPT_PORT _HPX_STATS_PORT _HPX_STATS_2_PORT _HPX_DOMAIN_FQDN _HPX_CT_NAME _HPX_ACCESS_USER _HPX_ACCESS_PWD _HPX_ACCESS_URI _HPX_DNS_DEFAULT _HPX_LCRYPT_EMAIL _SERVER_DEFAULT" ;;
            logrotate)
