...
_var_replace_vars() {
    ...
    case $1 in
        ...
        mail)
            vars="S_SERVICE[mail] S_PATH_CONF _SSL _DOMAIN_FQDN _EMAIL_TECH _PATH_SSL _PATH_VMAIL _PATH_LMAIL _PATH_SIEVE _DB_HOST _DB_NAME _DB_USER _DB_PWD _SSL_SCHEME _DB_PFA_USER _DB_PFA_PWD _CIDR _IPS_CLUSTER _VMAIL_USER _VMAIL_UID" ;;
        rspamd)
