...
_var_replace_vars() {
    local vars
        ...
        case $1 in
            apache)
                vars="S_VM_PATH_SHARE S_RSYSLOG_PTC S_RSYSLOG_PORT _DOM_FQDN _IPTHIS _IPS_AUTH _APA_PATH_WWW _APA_DOM_ADMIN _APA_SUB _APA_PATH_DOM _CIDR" ;;
            apache2)
            ...
            php)
                vars="_PHP_CACHE_CT _PHP_MAX_EXECUTION_TIME _PHP_MAX_INPUT_TIME _PHP_MEMORY_LIMIT _PHP_OPCACHE_REV _PHP_OPCACHE_SIZE _PHP_PATH_SHARE _PHP_POST_MAX_SIZE _PHP_SESSION_STRICT_MODE _PHP_UPLOAD_MAX_FILESIZE S_CACHE_PORT" ;;
            php2)
