...
_var_replace_vars() {
    local vars
        ...
        case $1 in
            ...
            rspamd)
                vars="S_RSPAMD_PORT[proxy] S_RSPAMD_PORT[normal] S_RSPAMD_PORT[controller] S_CACHE_PORT_RW S_CACHE_PORT_RO _MEL_CTS_RDS _IPS_CLUSTER _MEL_CIDR _MEL_PATH_SPAM _MEL_PATH_DKIM" ;;
            mariadb)
