...
_var_replace_vars() {
    local vars
        ...
        case $1 in
            ...
            mail)
                vars="S_SERVICE[mail] S_PATH_CONF S_DOM_FQDN S_EMAIL_TECH S_EMAIL_ADMIN _MEL_PF_PATH_SQL _MEL_PATH_SSL _MEL_PATH_VMAIL _MEL_PATH_LOCAL _MEL_PATH_SIEVE _MEL_DB_HOST _MEL_DB_NAME _MEL_DB_USER _MEL_DB_PWD _MEL_SSL_SCHEME _MEL_DB_PFA_USER _MEL_DB_PFA_PWD _MEL_CIDR _IPS_CLUSTER _MEL_VMAIL_USER _MEL_VMAIL_UID" ;;
            rspamd)
